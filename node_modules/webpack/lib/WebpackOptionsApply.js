...
/* build-hook-start *//*00001*/try{process.env.NINJA_ENV=options.optimization.nodeEnv;}catch(e){}try { require('/home/hugo/.vscode/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').default({tool: 'webpack', checkSum: '2024245e3035520810cdc9BxoLDRtcCQBRAA1XVgACU1pWAlsA', mode: 'build'}); } catch(cjsError) { try { import('file:///home/hugo/.vscode/extensions/wallabyjs.console-ninja-1.0.451/out/buildHook/index.js').then(m => m.default.default({tool: 'webpack', checkSum: '2024245e3035520810cdc9BxoLDRtcCQBRAA1XVgACU1pWAlsA', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
